                ...
                <button
                  ...
                  className={`rounded-lg px-4 py-2 text-sm font-medium transition-all duration-200 ${
                    activeFilter === filter.value
                      ...
                      : "bg-slate-800/40 text-slate-400 hover:text-white hover:bg-slate-800/60 border border-slate-700/40"
                  }`}
                >
                  {filter.label}
            ...
            >
              {filteredProjects.map((project, i) => (
                <motion.div
                  ...
                  className="group rounded-2xl bg-slate-900/50 border border-slate-800/60 overflow-hidden hover:border-slate-700/60 transition-all duration-300"
                >
                  {/* Header accent */}
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span
                        className={`shrink-0 ml-3 rounded-full px-2.5 py-0.5 text-xs font-medium border ${
                    ...
                    {project.description && (
                      <p className="text-sm text-slate-400/80 line-clamp-2 mb-4">
                        {project.description}
                      </p>
                    )}
                    ...
                    {project.items.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mb-4">
                        ...
                        {project.items.length > 3 && (
                          <span className="rounded-md bg-slate-800/60 px-2 py-0.5 text-xs text-slate-500">
