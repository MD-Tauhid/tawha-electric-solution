...
>(({ className, ...props }, ref) => (
  <div className="table-glass-wrapper relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn("table-glass w-full caption-bottom text-sm", className)}
      {...props}
    />
  </div>
));
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("table-glass-header [&_tr]:border-b", className)}
    {...props}
  />
));
